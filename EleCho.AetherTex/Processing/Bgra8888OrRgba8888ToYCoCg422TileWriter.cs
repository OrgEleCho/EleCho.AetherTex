...
{
    internal class Bgra8888OrRgba8888ToYCoCg422TileWriter : ITileWriter
    {
        ...
        public TextureFormat Target => TextureFormat.YCoCg422;

        public Bgra8888OrRgba8888ToYCoCg422TileWriter(ComPtr<ID3D11Device> device, ComPtr<ID3D11DeviceContext> deviceContext, TextureFormat source)
        {
            _device = device;
        ...
        public void WriteTile(TextureData textureData, ComPtr<ID3D11Texture2D> tileTexture1, ComPtr<ID3D11Texture2D>? tileTexture2, uint subResource)
        {
            ...
            }))
            {
                ...
                _cocgSplitProcessor.Process(shaderResourceView, rt, textureData.Width / 2, textureData.Height);

                var copySrcBox2 = new Box(0, 0, 0, (uint)(textureData.Width / 2), (uint)textureData.Height, 1);
        ...
        ~Bgra8888OrRgba8888ToYCoCg422TileWriter()
        {
