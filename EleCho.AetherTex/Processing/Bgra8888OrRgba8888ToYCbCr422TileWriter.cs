...
{
    internal class Bgra8888OrRgba8888ToYCbCr422TileWriter : ITileWriter
    {
        ...
        public TextureFormat Target => TextureFormat.YCbCr422;

        public Bgra8888OrRgba8888ToYCbCr422TileWriter(ComPtr<ID3D11Device> device, ComPtr<ID3D11DeviceContext> deviceContext, TextureFormat source)
        {
            _device = device;
        ...
        public void WriteTile(TextureData textureData, ComPtr<ID3D11Texture2D> tileTexture1, ComPtr<ID3D11Texture2D>? tileTexture2, uint subResource)
        {
            ...
            }))
            {
                ...
                _cbcrSplitProcessor.Process(shaderResourceView, rt, textureData.Width / 2, textureData.Height);
        ...
        ~Bgra8888OrRgba8888ToYCbCr422TileWriter()
        {
